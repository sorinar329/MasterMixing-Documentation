...
\newcommand{\secondreviewer}{Prof. Nico Hochgeschwender}
\newcommand{\supervisor}{Michaela Kümpel, Vanessa Hassouna}
\newcommand{\thesistype}{Master Thesis}
\newcommand{\myauthor}{Naser Azizi, Sorin Arion}
\newcommand{\mymaintitle}{A Knowledgebase with which you can parameterize robot plans for multiple mixing actions}
