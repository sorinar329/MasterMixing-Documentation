...
The \textit{Whirlstorm} motion was already an implemented motion in \nameref{sec:pycram} \cite{pycram}. In our version, we have slightly modified the motion (see \ref{sec:Motions}).
